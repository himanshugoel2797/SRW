...
#************************************* Starting the cycle through the drift after the lens
xRMS = []
yRMS = []
s = []
WRx = []
...
for i in range(len(intensitiesToPlot['intensity'])):
    ...
    uti_plot2d1d(intensitiesToPlot['intensity'][i],
