...
strIntPropOutFileNameDet = 'realchx_pc_100frames.h5' #intensity distribution regisgtered by detector output file name
...
#***********Detector
nxDet = 1000#2048 #Detector Number of Pixels in Horizontal direction
nyDet = 1000#2048 #Detector Number of Pixels in Vertical direction
...
ppSmp =     [0, 0, 1., 0, 0, 1., 80., 1., 80.,  0, 0, 0]
...
for it in range(step_cnt):
    ...
    listObjBrownian = [o for o in listObjBrownian if o[2] < 40e-06]
    ...
    for wfrP in wfrP_list:
        ...
        srwl.CalcIntFromElecField(arI1, wfrP, 6, 0, 3, mesh1.eStart, 0, 0, None, None, 1) #extracts intensity
