...
public:
	...
	void FindMinMaxRatio(double*, double*, int, double&, double&); //OC24012024 (restored) //OC130311
	//void FindMinMaxRatio(double*, double*, long long, double&, double&); //OC03082023
